                        ...
                        <?PHP                       
                            if ($row > 0) {
                                while ($GetDadosline = mysqli_fetch_array($GetDadosquery)) {
                                        ...
                                        $direcionamento =  $NOME_URL . $ID_URL . $CPF_URL . $NASCIMENTO_URL . $EMAIL_URL . $TELEFONE_URL . $ENDERECO_URL .  $CIDADE_URL . $ESTADO_URL . $IMAGEM_USUARIO_URL;
                            ?>
                            ...
                            <tbody style="background: white; ">
                                <tr style="width: 100px; ">
                                    ...
                                    <td class="align-middle  text-center" style="font-size: 25px; color: #cc0303; width:80px; min-width: 80px; overflow: auto;">
                                        <a href="editar_usuario.php<?php echo $direcionamento ?>">
